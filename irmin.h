...
_Bool irmin_value_equal(IrminType* x1093, IrminValue* x1092,
                        IrminValue* x1091);
int irmin_value_compare(IrminType* x1096, IrminValue* x1095,
                        IrminValue* x1094);
...
_Bool irmin_test_and_set_tree(Irmin* x1177, IrminPath* x1176,
                              IrminTree* x1175, IrminTree* x1174,
                              IrminInfo* x1173);
...
_Bool irmin_tree_mem_tree(IrminRepo* x1202, IrminTree* x1201,
                          IrminPath* x1200);
...
void irmin_tree_add(IrminRepo* x1212, IrminTree* x1211, IrminPath* x1210,
                    IrminValue* x1209);
void irmin_tree_add_tree(IrminRepo* x1216, IrminTree* x1215,
                         IrminPath* x1214, IrminTree* x1213);
