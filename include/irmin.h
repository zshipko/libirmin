...
IrminType* irmin_type_triple(IrminType* x1111, IrminType* x1110,
                             IrminType* x1109);
char* irmin_type_name(IrminType* x1113, uint64_t* x1112);
void irmin_type_free(IrminType* x1114);
IrminValue* irmin_value_unit(void);
IrminValue* irmin_value_int(int64_t x1116);
IrminValue* irmin_value_float(double x1117);
IrminValue* irmin_value_bool(_Bool x1118);
IrminValue* irmin_value_make(void* x1119);
IrminValue* irmin_value_string(char* x1121, int64_t x1120);
char* irmin_value_get_string(IrminValue* x1123, uint64_t* x1122);
int64_t irmin_value_get_int(IrminValue* x1124);
_Bool irmin_value_get_bool(IrminValue* x1125);
double irmin_value_get_float(IrminValue* x1126);
IrminValue* irmin_value_bytes(char* x1128, int64_t x1127);
...
IrminValue* irmin_value_array_new(uint64_t x1135, IrminValue* x1134);
void irmin_value_array_set(IrminValue* x1138, uint64_t x1137,
                           IrminValue* x1136);
IrminValue* irmin_value_array_get(IrminValue* x1140, uint64_t x1139);
...
IrminValue* irmin_value_triple(IrminValue* x1146, IrminValue* x1145,
                               IrminValue* x1144);
char* irmin_value_to_string(IrminType* x1149, IrminValue* x1148,
                            uint64_t* x1147);
IrminValue* irmin_value_of_string(IrminType* x1152, char* x1151,
                                  int64_t x1150);
char* irmin_value_to_bin(IrminType* x1155, IrminValue* x1154,
                         uint64_t* x1153);
IrminValue* irmin_value_of_bin(IrminType* x1158, char* x1157, int64_t x1156);
char* irmin_value_to_json(IrminType* x1161, IrminValue* x1160,
                          uint64_t* x1159);
IrminValue* irmin_value_of_json(IrminType* x1164, char* x1163, int64_t x1162);
...
IrminInfo* irmin_info_update(IrminRepo* x1178, char* x1177, char* x1176,
                             IrminInfo* x1175);
char* irmin_info_message(IrminRepo* x1181, IrminInfo* x1180, uint64_t* x1179);
char* irmin_info_author(IrminRepo* x1184, IrminInfo* x1183, uint64_t* x1182);
...
IrminPath* irmin_path_of_string(IrminRepo* x1206, char* x1205, int64_t x1204);
char* irmin_path_to_string(IrminRepo* x1209, IrminPath* x1208,
                           uint64_t* x1207);
...
char* irmin_hash_to_string(IrminRepo* x1230, IrminHash* x1229,
                           uint64_t* x1228);
IrminHash* irmin_hash_of_string(IrminRepo* x1233, char* x1232, int64_t x1231);
...
IrminCommit* irmin_commit_new(IrminRepo* x1320, IrminCommit** x1319,
                              uint64_t x1318, IrminTree* x1317,
                              IrminInfo* x1316);
uint64_t irmin_commit_parents_length(IrminRepo* x1322, IrminCommit* x1321);
